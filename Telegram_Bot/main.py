...
char_info = {
    ...
    'jedi': 'Привет! Я - Йодрик, троюродный внук самого магистра Йоды, ментором джедаев я являюсь. Готов указать путь решения твоих проблем любых, даже если в безвыходном положении, тебе кажется, ты оказался.',
...
help_dict = {
    ...
    ' \nЯ могу посоветовать тебе фильм, песню, просто поболтать с тобой.'+
    '\nУдачи!',
    ...
    '\nЕсли ты хочешь прекратить общение, нажми на кнопку «/end» в меню.'+
    '\nУдачи!'
}
